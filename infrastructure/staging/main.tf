...
module "github" {
  ...
  aws_automation_generate_wa_messages_function_name = module.core.aws_lambda_automation_generate_wa_messages_function_name
  ...
  sst_captcha_site_key                              = "1x00000000000000000000AA"
...
module "core" {
  ...
  aws_region                        = var.aws_region
  turnstile_widget_secret           = "1x0000000000000000000000000000000AA"
  domain_name                       = var.domain_name
...
module "mongodb" {
  ...
  staging_db_setup_lambda_username = module.core.staging_db_setup_lambda_username
}
