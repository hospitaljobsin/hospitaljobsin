...
export type PasskeysListInternalFragment$data = {
  ...
  readonly " $fragmentType": "PasskeysListInternalFragment";
};
export type PasskeysListInternalFragment$key = {
  readonly " $data"?: PasskeysListInternalFragment$data;
...
return {
  ...
  "metadata": {
    ...
    "refetch": {
      ...
      "operation": PasskeysListPaginationQuery_graphql,
      "identifierInfo": {
        "identifierField": "id",
  ...
  "selections": [
    {
      ...
      "kind": "LinkedField",
      "name": "__PasskeysListInternalFragment_webAuthnCredentials_connection",
      "plural": false,
      "selections": [
        {
          "alias": null,
