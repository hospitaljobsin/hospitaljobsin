...
export type OrganizationJobsListPaginationQuery = {
  response: OrganizationJobsListPaginationQuery$data;
  variables: OrganizationJobsListPaginationQuery$variables;
};
