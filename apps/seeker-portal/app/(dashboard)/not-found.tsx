...
import type { notFoundDashboardQuery } from "@/__generated__/notFoundDashboardQuery.graphql";
...
export default function NotFoundPage() {
	...
	const queryReference = loadQuery<notFoundDashboardQuery>(
		environment,
		notFoundQuery,
		{},
