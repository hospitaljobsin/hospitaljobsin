...
import type { notFoundJobDetailQuery } from "@/__generated__/notFoundJobDetailQuery.graphql";
...
export default function NotFoundPage() {
	...
	const queryReference = loadQuery<notFoundJobDetailQuery>(
		environment,
		notFoundQuery,
		{},
