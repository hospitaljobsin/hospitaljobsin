/**
 * @generated SignedSource<<a2b7654c67c9a534ecafd75341ffd200>>
...
return {
  ...
  "params": {
    "cacheID": "81ac69d5b4625a397d0e248778f1b202",
    "id": null,
    "metadata": {},
    "name": "OrganizationJobsListPaginationQuery",
    "operationKind": "query",
    "text": "query OrganizationJobsListPaginationQuery(\n  $count: Int = 10\n  $cursor: ID\n  $id: ID!\n) {\n  node(id: $id) {\n    __typename\n    ...OrganizationJobsListInternalFragment_1G22uz\n    id\n  }\n}\n\nfragment JobControlsFragment on Job {\n  id\n  isSaved\n  ...ShareJobFragment\n}\n\nfragment JobFragment on Job {\n  ...JobControlsFragment\n  slug\n  title\n  type\n  workMode\n  address {\n    city\n    state\n  }\n  skills\n  currency\n  hasSalaryRange\n  minSalary\n  maxSalary\n  hasExperienceRange\n  minExperience\n  maxExperience\n  createdAt\n  organization {\n    name\n    logoUrl\n    address {\n      city\n      state\n    }\n    id\n  }\n}\n\nfragment OrganizationJobsListInternalFragment_1G22uz on Organization {\n  jobs(after: $cursor, first: $count) {\n    edges {\n      node {\n        id\n        ...JobFragment\n        __typename\n      }\n      cursor\n    }\n    pageInfo {\n      hasNextPage\n      endCursor\n    }\n  }\n  id\n}\n\nfragment ShareJobFragment on Job {\n  slug\n  title\n  description\n  organization {\n    name\n    logoUrl\n    id\n  }\n}\n"
  }
};
})();
